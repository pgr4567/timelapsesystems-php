    ...
    <div id="container">
        ...
        <div id="tables">
            ...
            <div class="box_shadow" style="display: flex; flex-direction: row; align-items: center; justify-content: space-between;">
                ...
                echo "<a id=\"button-interactive\" style=\"display: flex; flex-direction: row; align-items: center; font-weight: 500; text-decoration: none; color: white; padding: 0.8rem 1.5rem; font-size: 1.2rem; border-radius: 30px;\" href=\"interaktiv.php?datum=" . $sanitized_date . "\">
                    <span>✨ Interaktive Fotoansicht<span>
                    <svg style=\"width: 1.3rem; height: 1.3rem; margin-left: 10px; transform: rotate(180deg);\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            ...
            foreach ($image_map as $hour => $images) {
                ...
                echo " <p style=\"margin: 0; text-align: center; font-weight: 600; font-size: 1.3rem;\">Stunde&nbsp;" . $hour . "</p>
