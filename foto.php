...
<body>
    <div id="container">
        ...
        <div id="tables">
            ...
            echo "<span class=\"box_shadow\"><a style=\"display: flex; flex-direction: row; align-items: center; font-weight: 500; text-decoration: none; color: #58666e;\" href=\"fotos.php?datum=" . $sanitized_date . "\"><svg style=\"width: 1rem; height: 1rem; margin-right: 10px;\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d=\"M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z\" /></svg>Bilder-Übersicht</a></span>";
            ...
            if ($prev_image) {
                ...
                echo "      <a class=\"back\" style=\"margin-right: 0.5rem;\" href=\"foto.php?hour=" . $hour . "&datum=" . $sanitized_date . "&pos=" . $pos + 1 . "\">" . "Vorheriges Bild" . "</a>\n";
            } else {
                echo "    <div class=\"center\">\n";
                echo "      <a class=\"back\" style=\"margin-right: 0.5rem;\">" . "Vorheriges Bild" . "</a>\n";
            }
            if ($next_image) {
                echo "      <a class=\"back\" style=\"margin-left: 1rem;\" href=\"foto.php?hour=" . $hour . "&datum=" . $sanitized_date . "&pos=" . $pos - 1 . "\">" . "Nächstes Bild" . "</a><br>\n";
                ...
                echo "      <a class=\"back\" style=\"margin-left: 1rem;\">" . "Nächstes Bild" . "</a>\n";
                echo "    </div>\n";
            }
            ?>
        </div>
